...
with open(file_to_save, "w") as txt_file:
    ...
    for county, vote_count  in county_votes_dict.items():
        county_name = county
        ...
        print(f"{county_name}: {vote_percentage:.1f}% ({county_vote_count:,})\n")
    ...
    print(f"Largest County Turnout: {winning_county_turnout}")
